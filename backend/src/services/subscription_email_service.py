...
class SubscriptionEmailService:
    ...
    def _build_subscribed_email(self, user: User) -> EmailContent:
        ...
        return EmailContent(
            subject="Thanks for subscribing to HanClipper",
            html=(
                f"<p>Hi {first_name},</p>"
                "<p>Thanks for subscribing to HanClipper.</p>"
            ...
            text=(
                f"Hi {first_name},\n\n"
                "Thanks for subscribing to HanClipper.\n\n"
    ...
    def _build_unsubscribed_email(self, user: User) -> EmailContent:
        first_name = self._first_name_for(user)
        return EmailContent(
            subject="Sorry to see you go from HanClipper",
            html=(
                f"<p>Hi {first_name},</p>"
                "<p>Sorry to see you go, and thanks for trying HanClipper.</p>"
                "<p>Your subscription has been canceled. If you ever want to come back, we’d love to have you.</p>"
                "<p>Team HanClipper</p>"
            ),
            text=(
                f"Hi {first_name},\n\n"
                "Sorry to see you go, and thanks for trying HanClipper.\n\n"
