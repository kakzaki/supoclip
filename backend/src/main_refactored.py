...
def create_app(
    *,
    ...
    async def lifespan(app: FastAPI):
        ...
        logger.info("🚀 Starting HanClipper API...")
        try:
            await init_db()
            ...
            logger.info("🛑 Shutting down HanClipper API...")
            await close_db()
    ...
    app = FastAPI(
        ...
        description="Refactored Python backend for HanClipper with async job processing",
        version="0.2.0",
        lifespan=lifespan,
    )
