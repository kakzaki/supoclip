...
This guide explains the visible parts of HanClipper and the main user flows.

## Product Summary

HanClipper turns long-form videos into short clips. Users can:
...
HanClipper uses Better Auth with an email and password flow backed by PostgreSQL through Prisma.
