...
export const metadata: Metadata = {
  title: "HanClipper Blog | AI Video Clipping Guides",
  description:
    "SEO guides, product comparisons, and creator workflows for turning long-form video into social-ready shorts with HanClipper.",
  alternates: {
    canonical: `${getSiteUrl()}/blog`,
  },
  openGraph: {
    title: "HanClipper Blog",
    description:
